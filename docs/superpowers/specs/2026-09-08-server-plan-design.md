...
>
> **Note on hygiene:** A structural formatting pass was applied after transfer (section headings promoted to `##`, ASCII diagrams fenced, JSON/YAML/snippet blocks fenced). No wording or content changes were made.
